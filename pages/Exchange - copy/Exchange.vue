<template>
	<view class="page-wrap">
        ...
        <view class="slj-img mt30" @click="toRelease">
            <image src="http://120.24.56.30:9000/system/gg1.jpg" ></image>
        </view>
		<view class="interest" v-if="false">
...
<script>
	...
	export default {
		...
		methods:{
            ...
            toRelease(){
               uni.navigateTo({
               	url:'/pages/Release/Release?type=3'
               }) 
            }
