...
/* harmony import */ var _InvitationDetail_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./InvitationDetail.vue?vue&type=style&index=0&lang=scss& */ 127);
...
try {
  components = {
    uSwiper: function() {
      return __webpack_require__.e(/*! import() | uview-ui/components/u-swiper/u-swiper */ "uview-ui/components/u-swiper/u-swiper").then(__webpack_require__.bind(null, /*! @/uview-ui/components/u-swiper/u-swiper.vue */ 220))
    },
    uSelect: function() {
...
//
//
var _default = { components: {}, data: function data() {return { showSortType: false, showMoreList: false, showEvaInput: false, focus: false, sortType: '最新', sortTypeList: [{ label: '最新', value: 1 }, { label: '最热', value: 2 }], list: [{ image: 'https://cdn.uviewui.com/uview/swiper/1.jpg' }, { image: 'https://cdn.uviewui.com/uview/swiper/2.jpg' }, { image: 'https://cdn.uviewui.com/uview/swiper/3.jpg' }], moreList: [{ label: '收藏', value: 1 }, { label: '删除', value: 2 }, { label: '分享', value: 3 }, { label: '邀请好友', value: 4 }], toolList: [{ label: '转发', num: 50, value: 1 }, { label: '评论', num: 50, value: 2 }, { label: '反对', num: 50, value: 3 }, { label: '赞同', num: 50, value: 4 }], commont: '' };}, watch: { "showEvaInput": function showEvaInput(val) {this.focus = val;}, "focus": function focus(val) {console.log(111, val);} }, methods: { // 预览图片
    prewImage: function prewImage(e) {(0, _util.previewImage)(this.list);}, // 选择排序
    confirm: function confirm(e) {console.log(e);this.sortType = e[0].label;}, // 查看更多评论
    showMore: function showMore() {uni.navigateTo({ url: '/pages/CommentList/CommentList' });}, // 底部评论
    toolHandle: function toolHandle(item, index) {if (index == 1) {this.showEvaInput = true;}}, dropDownChange: function dropDownChange(e) {console.log(e);}, // 更多
    selectMore: function selectMore(item) {console.log(item);} } };exports.default = _default;
