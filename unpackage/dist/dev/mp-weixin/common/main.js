...
var mpShare = __webpack_require__(/*! uview-ui/libs/mixin/mpShare.js */ 49);_vue.default.mixin(mpShare);_vue.default.prototype.$http = _http.http;_vue.default.prototype.$getUserInfo = _util.getUserInfo;var app = new _vue.default(_objectSpread({ store: _store.default }, _App.default)); // http拦截器，将此部分放在new Vue()和app.$mount()之间，才能App.vue中正常使用
...
var _util = __webpack_require__(/*! @/utils/util.js */ 8);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
